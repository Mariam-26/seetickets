...
final class Version20240304122311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, event_name VARCHAR(255) NOT NULL, event_place VARCHAR(255) NOT NULL, orgasisation_name VARCHAR(255) NOT NULL, event_image VARCHAR(255) NOT NULL, INDEX IDX_3BAE0AA712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
